...
Decision records explain durable choices that should not drift during future
rewrites. They are append-only: supersede a decision with a new record rather
than silently changing its outcome.
